...
def main():
    parser = argparse.ArgumentParser(
        description="Classify images in data/images/crop using exported fastai model"
    )
    parser.add_argument(
        "--model",
        "-m",
        type=str,
        default=None,
        help="Path to exported fastai learner (.pkl)",
    )
    parser.add_argument(
        "--input",
        "-i",
        type=str,
        default="data/images/crop",
    ...
    parser.add_argument(
        ...
        "-o",
        type=str,
        default="data/images/crop/predictions.csv",
    ...
    try:
        ...
        print(
            "Fehler: fastai nicht installiert oder Import fehlgeschlagen:",
            e,
            file=sys.stderr,
        )
        sys.exit(2)
    ...
    if not model_path or not model_path.exists():
        print(
            "Exportiertes Model nicht gefunden. Setze --model / Pfad prüfen.",
            file=sys.stderr,
        )
        sys.exit(3)
